...
const TotalVisitcard = () => {
  ...
  return (
    <div className='flex items-center justify-center w-auto space-x-8 mt-11 mx-auto '>
      {data.map((item, index) => {
          return(
               <div className="flex flex-col gap-8  w-[28rem] justify-center bg-white  rounded-2xl px-7 pb-7" key={index}>
                    ...
                    <div className="flex items-center justify-between">
                         <div className="flex gap-16 items-center justify-between ">
                              <div className="flex flex-col">
                                   <h3 className='text-3xl text-blue-900 font-futura font-bold'>{item.visitor}</h3>
                                   <p className='text-[1rem] tracking-wide capitalize text-textB'>{item.heading[0]}</p>
                              </div>
                              <hr className='h-15 w-[1px] bg-[#ccc] border-0 outline-0' />
                              <div className="">
                                   <h3 className='text-3xl text-blue-900 font-futura font-bold'>{item.AuTotal}</h3>
                                   <p className='text-[1rem] tracking-wide capitalize text-textB'>{item.heading[1]}</p>
                              </div>
                         </div>
                    </div>
               </div>
